...
\usepackage[inner=1.35cm, outer=0.9cm, top=1.1cm, bottom=1.1cm]{geometry}
\usepackage{pdfpages}
\usepackage{tocloft}
\usepackage{nameref}
\usepackage{verbatim}
...
\titlespacing*{\subsubsection}{0pt}{-0.1\baselineskip}{0.0\baselineskip}
...
\center\fontsize{80.0pt}{\baselineskip}\selectfont Let it Rot


{\LARGE
\begin{tabular}{ccc}
\centering
\rule{0pt}{16pt} 钱易 & 彭博 & 冯施源 \\
\rule{0pt}{16pt} Yi Qian & Bo Peng & Shiyuan Feng \\
\end{tabular}
}
