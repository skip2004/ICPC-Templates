...
\usepackage{minted, listings, color, setspace, titlesec, fancyhdr, mdframed, multicol, relsize, xeCJK}
...
\subsection{拟阵交}
\input{contents/graph/拟阵交.tex}


\section{数论}	

\subsection{扩展欧几里得}
\inputminted{cpp}{contents/math/exgcd.cpp}

\subsection{万能欧几里得}
\inputminted{cpp}{contents/math/Euclid.cpp}
...
\inputminted{cpp}{contents/math/floor_sum.cpp}

\subsection{Stern-Brocot Tree 二分}

\inputminted{cpp}{contents/math/sbt.cpp}

\subsection{扩展中国剩余定理}
\inputminted{cpp}{contents/math/exCRT.cpp}

\subsection{Miller-Rabin}
\inputminted{cpp}{contents/math/Miller_Rabin.cpp}

\subsection{Pollard-rho}
\inputminted{cpp}{contents/math/pollard_rho.cpp}
...
\inputminted{cpp}{contents/math/GF.cpp}
...
需要两倍点数量。
\inputminted{cpp}{contents/string/new-sam.cpp}

\subsection{基本子串字典}
\inputminted{cpp}{contents/string/基本子串字典.cpp}

\subsection{DAG 剖分}
\inputminted{cpp}{contents/string/dag剖.cpp}

\subsection{exKMP}
\inputminted{cpp}{contents/string/exkmp.cpp}

\subsection{log 个最小后缀}
\inputminted{cpp}{contents/string/log个最小后缀.cpp}

\subsection{SA}
\inputminted{cpp}{contents/string/SA.cpp}

\subsection{PAM}
\inputminted{cpp}{contents/string/new-pam.cpp}
...
\subsection{Runs}
\inputminted{cpp}{contents/string/run.cpp}
...
\subsection{bash 命令}
\inputminted{text}{contents/tables/bashcmd.txt}
